...
export const SEED_PROJECTS: ProjectInput[] = [
  {
    ...
    videos: [
      ...
      { youtubeId: "Sw3tEcz2PK0", label: "Brand Story" },
  ...
  },
  {
    ...
    videos: [
      ...
      { youtubeId: "nJCs11P9iDQ", label: "Campaign" },
  ...
  },
  {
    ...
    videos: [
      ...
      { youtubeId: "XHBPn_ELA30", label: "Campaign" },
  ...
  },
  {
    ...
    videos: [
      ...
      { youtubeId: "G0BV-ZqA5qE", label: "Campaign" },
      { youtubeId: "nlfTweqlfQc", label: "Patient Stories" },
  ...
  },
  {
    ...
    videos: [
      ...
      { youtubeId: "mat96IEwIqg", label: "Product Spot" },
  ...
  },
  {
    ...
    videos: [
      ...
      { youtubeId: "kkrTmkYrPsw", label: "Documentary" },
      { youtubeId: "PzaI5jWJCEE", label: "Awareness" },
      { youtubeId: "SXtrDI6ps6c", label: "Campaign" },
